...
function GraphD3(props) {
  const { dispatch, data, width, height, padding, id, autoLayout, deformFlag, saveModify } = props;
  ...
  const drawForce = () => {
    ...
    function dragEnd() {
      setCurGraphData({"nodes": JSON.parse(JSON.stringify(nodes)), "links":visData.links});
    }
